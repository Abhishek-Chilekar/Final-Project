    ...
    return <div className={style.overlay}>
        ...
        <div className={style.header}>
            ...
            <div className={style.members}>
                {users.map((user) => 
                    ((search.name==""||(user.FullName+"".toLowerCase()).includes(search.name.toLowerCase()))
                    ...
                    &&(search.year == "All"||user.year == search.year)&&(user.role != "Student" || (search.branch == "All"||user.branch == search.branch)))&&(<>
                        <div className={style.container}>
                            ...
                            {(checkMembers(user.id))&&<button className={style.butto} onClick={status?()=>{}:()=>{setStatus(true);handleClick(user)}}>{"Add"}</button>}
                        </div>
                    </>)
                )}
