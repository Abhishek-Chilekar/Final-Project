    ...
    const upload =async(data)=>{
        ...
        try
        {
            ...
            const resource = {
                ...
                url:data.name+"."+res.data.fileName.split('.')[1],
        ...
        <form onSubmit={handleSubmit(async(data)=>{
           await upload(data)
            ...
            <div className={style.upperdiv}>
                ...
                <input className={style.upload} type="file" accept=".doc, .docx, .pdf, .xlsx, .pptx, .ppt" name="file" id="file" required onChange={(e)=>setFile(e.target.files[0])}/>
