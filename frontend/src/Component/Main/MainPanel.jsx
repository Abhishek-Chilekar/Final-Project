...
const MainPanel = () =>{
    ...
    return(
        <div className={(Nav.active == "Notification" || Nav.active == "About")? style.mainLarge:style.main}>
            ...
            {(Nav.active == "Chats"&&popup)&&<Popup popupstate={setPopup}/>}
           <div className={style.header}>
            ...
            {(Nav.active == "Chats"?<MessageList select={select} />:Nav.active == "Resources"?<ResourceList select={select}/>:Nav.active == "Events"?<EventList/>:Nav.active == "Notification"?<NotificationList />:Nav.active == "Search"&&<Search getText={getText}/>)}
        </div>
    );
}
